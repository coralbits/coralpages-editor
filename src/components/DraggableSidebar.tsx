    ...
    >
      ...
      >
        ...
        {buttons.map((button, idx) => (
          <button
            key={idx}
            className={`bg-slate-700 dark:bg-slate-800 border border-blue-500 dark:border-blue-400 p-2 rounded-md hover:bg-blue-600 dark:hover:bg-blue-500 hover:text-white hover:cursor-pointer transition-colors duration-200 ${
              button.className || ""
            }`}
