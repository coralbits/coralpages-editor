...
const MainContent = ({ page_hooks, editor_hooks }: MainContentProps) => {
  ...
  return (
    <div
      className="relative flex flex-col h-full flex-1 bg-slate-800 dark:bg-slate-900 m-auto items-center justify-center"
      id="main-content"
    >
      <div className="absolute top-3 right-3 flex flex-row gap-0 bg-slate-700 dark:bg-slate-800 rounded-md p-1">
        <button
